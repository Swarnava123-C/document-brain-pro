    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="relative hidden overflow-hidden gradient-mesh lg:block" aria-hidden="true">
        ...
        <div className="relative flex h-full flex-col justify-between p-12 text-foreground">
          <Link to="/" aria-label="IndustrialMind AI home"><Logo /></Link>
          <div>
      ...
      <main className="flex items-center justify-center bg-background px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 space-y-3">
            <Button type="button" variant="outline" className="w-full justify-center gap-2 border-border/70" onClick={onGoogle} disabled={loading}>
              <svg className="h-4 w-4" viewBox="0 0 24 24" aria-hidden="true"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.19 3.32v2.76h3.54c2.08-1.91 3.29-4.74 3.29-8.09Z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.54-2.76c-.98.66-2.24 1.05-3.74 1.05-2.87 0-5.3-1.94-6.17-4.55H2.18v2.85A11 11 0 0 0 12 23Z"/><path fill="#FBBC05" d="M5.83 14.08a6.6 6.6 0 0 1 0-4.16V7.07H2.18a11 11 0 0 0 0 9.86l3.65-2.85Z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.07.56 4.21 1.65l3.15-3.15C17.45 2.09 14.97 1 12 1A11 11 0 0 0 2.18 7.07l3.65 2.85C6.7 7.32 9.13 5.38 12 5.38Z"/></svg>
          ...
          <form className="space-y-4" onSubmit={onSubmit}>
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <Input id="email" type="email" required placeholder="you@company.com" className="pl-9" value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="email" />
              </div>
            </div>
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <Input id="password" type="password" required placeholder="••••••••" className="pl-9" value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" />
              </div>
            </div>
            <Button type="submit" disabled={loading} className="h-11 w-full gradient-primary text-white shadow-elegant hover:opacity-95">
